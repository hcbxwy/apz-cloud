...
import com.hcbxwy.apz.common.web.exception.ParameterInvalidException;
...
public enum BusinessExceptionEnum {
     ...
     * 参数无效
     */
    PARAMETER_INVALID(ParameterInvalidException.class, HttpStatus.BAD_REQUEST, ResultCodeEnum.PARAM_IS_INVALID);
...
//     * 接口方法不允许
//     */
//    METHOD_NOT_ALLOWED(MethodNotAllowException.class, HttpStatus.METHOD_NOT_ALLOWED, ResultCodeEnum.INTERFACE_ADDRESS_INVALID),
//
//    /**
//     * 数据已存在
//     */
...
//     * 远程访问时错误
//     */
//    REMOTE_ACCESS_ERROR(RemoteAccessException.class, HttpStatus.INTERNAL_SERVER_ERROR, ResultCodeEnum.INTERFACE_OUTTER_INVOKE_ERROR),
//
//    /**
//     * 系统内部错误
//     */
//    INTERNAL_SERVER_ERROR(InternalServerException.class, HttpStatus.INTERNAL_SERVER_ERROR, ResultCodeEnum.SYSTEM_INNER_ERROR);
    ...
    BusinessExceptionEnum(Class<? extends BusinessException> eClass, HttpStatus httpStatus, ResultCodeEnum resultCodeEnum) {
        this.eClass = eClass;
